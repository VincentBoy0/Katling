    ...
    <div className="p-8">
      <div className="mb-8 flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-2">Create and post new learning content for students</p>
        </div>
        <button
      ...
      <div className="bg-card border border-border rounded-xl overflow-hidden">
        <div className="p-6 border-b border-border bg-muted/30">
          <h3 className="font-semibold text-foreground">My Created Posts ({createdPosts.length})</h3>
        </div>

        {createdPosts.length === 0 ? (
          <div className="p-12 text-center">
            <p className="text-muted-foreground">No posts created yet. Create your first content!</p>
          </div>
        ) : (
              ...
              <tbody>
                {createdPosts.map((post) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-sm text-muted-foreground">{post.difficulty}</td>
                    ...
                    <td className="px-6 py-4">
                      ...
                      >
                        {confirmingId === post.id && <Check className="w-3 h-3 inline mr-1" />}
                        {post.status}
                      </span>
                    </td>
                  </tr>
