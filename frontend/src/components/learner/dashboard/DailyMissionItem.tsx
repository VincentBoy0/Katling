...
const getMissionIcon = (description: string): string => {
  ...
  if (lowerDesc.includes("listening") || lowerDesc.includes("nghe")) return "🎧";
  ...
  if (lowerDesc.includes("vocabulary") || lowerDesc.includes("từ vựng")) return "📚";
  if (lowerDesc.includes("grammar") || lowerDesc.includes("ngữ pháp")) return "📝";
  ...
  return (
    <div
      className={`bg-white rounded-lg p-4 border-2 transition-all ${
        isCompleted ? "border-green-400 shadow-md" : "border-gray-100"
      }`}
    >
